 ...
 */
class getUriSignerService extends App_KernelProductionDebugContainer
{
    /**
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['uri_signer'] = $container->createProxy('UriSignerGhostA83cc5f', static fn () => \UriSignerGhostA83cc5f::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
